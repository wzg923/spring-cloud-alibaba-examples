...
/**
  ...
  * @Description Dubbo Spring Cloud Consumer Bootstrap
  * @Date 10:24 2019/07/19
  * @Param
  * @return
  **/
...
public class DubboSpringCloudConsumerBootstrap {
    ...
    /*Dubbo服务原生调用（服务支持多种协议的[dubbo、rest]，可以指定协议*/
    @Reference(version = "1.0.0", protocol = "dubbo")
    private RestService restService;

    /*Feign方式调用服务，可以是rest协议的dubbo服务，也可以是http协议的SpringCloud服务*/
    @Autowired
    @Lazy
    private FeignRestService feignRestService;
    /*Feign方式调用服务，调用dubbo协议的dubbo服务*/
    @Autowired
    @Lazy
    ...
    /**
     * @Author wangzhenguang
     * @Description Feign方式服务调用，可以是rest协议的dubbo服务，也可以是http协议的SpringCloud服务
     * @Date 10:20 2019/07/19
     * @Param
     * @return
     **/
    @FeignClient("${provider.application.name}" ) //服务ID/服务应用名称
    ...
    /*
     * @Author wangzhenguang
     * @Description Feign方式调用Dubbo服务，RPC服务dubbo协议传输，必须进行协议转换@DubboTransported(protocol = "dubbo")
